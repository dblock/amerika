  ...
  it('should respond', function(done) {
    chai.request(server.express)
      ...
      .end(function(err, res) {
        ...
        expect(data.response.outputSpeech.ssml).to.equal("<speak>I'm your president. You can ask America to be great again and I will give you one of my priceless quotes.</speak>");
